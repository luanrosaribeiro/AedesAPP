...
@NamedQueries({
    ...
    @NamedQuery(name = "Admins.login", query = "SELECT a FROM Admins a WHERE a.email=:email and a.senha=:senha")})
public class Admins implements Serializable {
    ...
    public Admins(Integer id, String email) {
        this.id = id;
        this.email = email;
    }
